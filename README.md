...
* Easy integration with page builders like Elementor, Divi, WPBakery (Visual Composer), etc.
...
4. Add the CSS class `acp-trigger-popup` to any button, link, or element where you want to trigger the popup.

## Integration with Page Builders

* **Elementor**: Edit the button widget, go to **Advanced -> CSS Classes**, and add `acp-trigger-popup`.
* **Divi**: Open the Button module settings, go to the **Advanced** tab, then **CSS ID & Classes**, and add `acp-trigger-popup` to the **CSS Class** field.
* **WPBakery / Visual Composer**: Edit the button or element, add `acp-trigger-popup` in the **Extra class name** field.
* **Gutenberg (Block Editor)**: Select the button block, go to **Advanced** in the block settings sidebar, and add `acp-trigger-popup` to **Additional CSS class(es)**.
